...
<center>
       <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">BIENVENIDO AL SISTEMA DE CONTROL DE OXIGENO MEDICINAL <br><br><span class="">Usuario: {{ Auth::user()->name }}</span> </h1>
            </div>
        </div>
        </center>
      ...
      use App\Unidades;
         ...
         ?>
            ...
            <article class="tile">
             ...
             @endcan
            <article class="tile">
                <div class="tile-icon full-reset"><a href="{{route('inactivo')}}"><i class="zmdi zmdi-close-circle"></i></a></div>
            ...
            <article class="tile">
                <div class="tile-icon full-reset"><a href="{{route('activos')}}"><i class="zmdi zmdi-check-circle"></i></a></div>
