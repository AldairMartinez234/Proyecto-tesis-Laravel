...
<select class="form-control" name="tipo" required="">
  ...
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="nombre" placeholder="Escriba el nombre del paciente" id="nombre" required="" > 
  </div>
   <div class="form-row">
...
$municipio = DB::SELECT("SELECT distinct municipio FROM sepomex where estado='morelos' ");
 ...
 ?>
    ...
    <div class="form-group col-md-2">
      ...
      <input type="number" class="form-control" name="cp" data-toggle="tooltip" data-placement="top"  required="" >
    </div>

    <div class="form-group col-md-7">
     <label for="direc">Dirección</label>
    <input type="text" class="form-control" name="calle" placeholder="Escriba la dirección" data-toggle="tooltip" data-placement="top"  required="">
  </div>

    <div class="form-group col-md-8">
    <label for="refe">Referencias</label>
    <input type="text"class="form-control" name="referencias" placeholder="" data-toggle="tooltip" data-placement="top"  required="">
    </div>
<br><br><br><br><br><br><br><br>
  ...
  <div class="form-group col-md-4">
    <label for="name">Nombre</label>
    <input type="text" class="form-control" name="namefami" placeholder="Escriba el nombre del paciente" data-toggle="tooltip" data-placement="top"  required="">
  </div>

    <div class="form-group col-md-2">
     <label>Sexo: </label>
      <select id="inputState" class="form-control" data-toggle="tooltip" data-placement="top" name="sex"  required="" >
    ...
    <div class="form-group col-md-3">
      ...
      <input type="number" class="form-control" name="telfami" data-toggle="tooltip" data-placement="top"  required="" >
    </div>

    <div class="form-group col-md-3">
      <label >Celular</label>
      <input type="number" class="form-control" name="celfami" data-toggle="tooltip" data-placement="top"  required="" >
    </div>
  ...
  <div class="form-group col-md-2">
      <label for="cp">Codigo Postal</label>
      <input type="number" class="form-control" name="cpfami" data-toggle="tooltip" data-placement="top"  required="" >
    </div>

  <div class="form-group col-md-7">
    <label for="direccion1">Dirección</label>
    <input type="text" class="form-control" name="direcfami" placeholder="Escriba la dirección" data-toggle="tooltip" data-placement="top"  required="">
  </div>

<div class="form-group col-md-9">
    <label for="referencias1">Referencias</label>
    <input type="text" class="form-control" name="refefami" placeholder="" data-toggle="tooltip" data-placement="top"  required="">
  </div>
  ...
  <button type="reset" class="btn btn-info"><i class="zmdi zmdi-floppy"></i>    {{ __('Limpiar') }}</button>
  <button type="button" class="btn btn-primary guardar"><i class="zmdi zmdi-floppy" ></i>    {{ __('Guardar') }}</button>
  <button type="submit" id="lector" class="btn btn-danger"><i class="glyphicon glyphicon-save-file"> </i> Registar Huella </button>
</p>
</form>
</div>
</div>
...
<script>
  function huella(){
    window.open("https://control-de-oxigeno-issste.000webhostapp.com/Biometrico/BiometricoISSSTE.application" , "Captura de Huella" , "width=50,height=50")
  } 
  document.getElementById("lector").onclick = function () {
    huella();
  }
