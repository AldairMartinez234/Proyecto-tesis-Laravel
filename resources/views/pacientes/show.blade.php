...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
  <fieldset style="border-radius: 5px; padding: 5px; min-height:150px; border:8px solid  #7E030A; background-color:#eeece1;">
  	<legend align="center" style=" margin-left:20px;background-color:#7E030A; padding-left:10px; padding-top:5px; padding-right:120px; padding-bottom:5px; ; color:white; border-radius:15px; border:8px solid #eeece1; font-size:25px;"><b >Datos del paciente</b></legend>
    ...
    <fieldset style="border-radius: 5px; padding: 5px; min-height:150px; border:8px solid  #7E030A; background-color:#eeece1;">
    <legend align="center" style=" margin-left:20px;background-color:#7E030A; padding-left:10px; padding-top:5px; padding-right:120px; padding-bottom:5px; ; color:white; border-radius:15px; border:8px solid #eeece1; font-size:25px;"><b>Dirección del paciente</b></legend>
    <div style="padding:  10px 90px 20px;">
    ...
    <fieldset style="border-radius: 5px; padding: 5px; min-height:150px; border:8px solid  #7E030A; background-color:#eeece1;">
     <legend  align="center" style=" margin-left:20px;background-color:#7E030A; padding-left:10px; padding-top:5px; padding-right:120px; padding-bottom:5px; ; color:white; border-radius:15px; border:8px solid #eeece1; font-size:25px;"><b>Datos del familiar</b></legend>
     <div style="padding:  10px 90px 20px;">
