        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                       ...
                       <div class="form-group col-md-6">
                            <label>Nombre</label>
                                <input id="name" type="text" class="form-control" name="name" value=""  data-toggle="tooltip" data-placement="top" disabled>
                        </div>
                      

                        <div class="form-group col-md-6">
                            <label for="email">{{ __('Correo Electronico') }}</label>
                                <input id="email" type="email" class="form-control"  value=''  data-toggle="tooltip" data-placement="top" disabled>
                        </div>

                        <div class="form-group col-md-6">
                            <label>Puesto</label>
                                <input id="rol" type="text" class="form-control" value=""  data-toggle="tooltip" data-placement="top" disabled>
                        </div>
                      
                        <div class="form-group col-md-6">
                            <label for="email">{{ __('Sexo') }}</label>
                                <input id="sexo" type="text" class="form-control"  value=''  data-toggle="tooltip" data-placement="top" disabled>
                        </div>

                         <div class="form-group col-md-6">
                            <label for="email">{{ __('Tipo Usuario') }}</label>
                                <input id="tipo_usuario" type="text" class="form-control"  value='' data-toggle="tooltip" data-placement="top" disabled>
                        </div>
