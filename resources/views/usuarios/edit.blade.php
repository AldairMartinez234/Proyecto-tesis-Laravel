        ...
        <div class="modal-dialog" role="document" data-backdrop="static">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-6">
                        <label>Nombre</label>
                        <input id="nombre" type="text" class="form-control" value="" required autocomplete="name"
                            data-toggle="tooltip" data-placement="top">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="email">{{ __('Correo Electronico') }}</label>
                        <input id="correo" type="email" class="form-control" value='' required autocomplete="email"
                            data-toggle="tooltip" data-placement="top">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" data-toggle="tooltip" data-placement="top" value=" "
                            title="Elige la sección a la que pertenece el alumno" id='role'>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="passs" type="password" class="form-control" name="passs" required
