    ...
    <div class="modal-dialog" data-backdrop="static">
        ...
        <div class="container-fluid"  style="margin: 0px 0;">
            <div class="page-header">
              <h3 class="text-center all-tittle">SISTEMA DE CONTROL DE OXIGENO MEDICINAL <br><small>Administración de unidades medicas</small></h3>
            </div>
        </div>
              <div class="text-center all-tittle">REGISTRO PARA CREAR UNA NUEVA UNIDA MEDICA</div>
            </div>
            <div class="modal-body">
              <form action="{{action('\App\Http\Controllers\Unidades_MedicasController@addunidades')}}" method="POST" id="userForm" >
                {{ csrf_field() }}
