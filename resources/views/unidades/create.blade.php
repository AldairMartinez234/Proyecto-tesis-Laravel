<div class="container">
    <div class="modal fade" id="create_unidades" tabindex="-1" role="dialog">
        <div class="modal-dialog" data-backdrop="static">
            <div class="modal-content">
                    ...
                    <div class="container-fluid" style="margin: 0px 0;">
                        <div class="page-header">
                            <h3 class="text-center all-tittle">SISTEMA DE CONTROL DE OXIGENO MEDICINAL
                                <br><small>Administración de unidades medicas</small></h3>
                        </div>
                    </div>
                    <div class="text-center all-tittle">REGISTRO PARA CREAR UNA NUEVA UNIDA MEDICA</div>
                </div>
                <div class="modal-body">
                    <form action="{{action('\App\Http\Controllers\Unidades_MedicasController@addunidades')}}"
                        ...
                        <div class="form-group col-md-6">
                            <label>Unidad</label>
                            <input type="text" class="form-control" id="unidad" name="unidad" data-toggle="tooltip"
                                data-placement="top">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="tel_parti" name="tel_parti"
                                data-toggle="tooltip" data-placement="top">
                        </div>

                        <div class="form-group col-md-6">
                            <label>Telefono Particular (opcional)</label>
                            <input type="number" class="form-control" id="tel_parti1" name="tel_parti1"
                                data-toggle="tooltip" data-placement="top">
                        </div>
                ...
                <div class="modal-footer">
                    <p class="text-center">
                        <button type="submit" class="btn btn-primary" id="addunidades"><i class="zmdi zmdi-floppy"></i>
                            {{ __('Guardar') }}
                        </button>
