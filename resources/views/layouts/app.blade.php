...
<body class="hold-transition skin-blue sidebar-mini" style="background-color: #13322B">
  <div class="wrapper">
    <header class="main-header">
      <a href="/" class="logo">
        <span class="logo-mini">
          <font size="2"><b>SC</b>OMD</font>
        </span>
        <span class="logo-lg">
          <font size="1">SISTEMA DE CONTROL DE OXIGENO MEDICINAL</font>
        </span>
      </a>
    ...
    <form class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li class="header" style="background-color: #13322B; color: #fff;">
            <center><B>
                <font size="2">MENU
              </B></font>
            </center>
          ...
          <li><a href="{{route('administrador.index')}}"><i class="glyphicon glyphicon-folder-close"> </i>
