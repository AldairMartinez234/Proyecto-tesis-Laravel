            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-6">
                        <label>ID</label>
                        <input id="id" type="text" class="form-control" name="id" value="" data-toggle="tooltip"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="name" type="text" class="form-control" value='' data-toggle="tooltip"
                            data-placement="top" disabled>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <label>Slug</label>
                        <input id="slug" type="text" class="form-control" name="slug" value="" data-toggle="tooltip"
                            data-placement="top" disabled>
                    </div>
