...
<br><span style="float:right">
   <pre> Folio No. <input type="number"  value="{{$resumens->folio}}" name="folio" size="10" style="border-radius: 5px; border: 1px solid #39c;" /></pre> </span>
    <br><br><br>
    <span style="float:right"> 
    <label>Fecha y hora: <input type="datatime"  name="fecha"  value="{{$resumens->fecha}}" disabled style=" border-radius: 5px; border: 1px solid #39c; text-align: center;"></label>
</span>
     <br><br>
     <div class="form-row">
...
<div class="form-row">
 <pre>      Unidad medica a la que se contrarefiere: <input type="text" value="{{$resumens->unidadcontrarefiere}}"  name="contrarefiere" size="10" style="width: 490px; border-radius: 5px; border: 1px solid #39c;"/>  Nivel de atencion: <input type="text" value="{{$resumens->nivelatencion}}"  name="atencion" size="10" style="width: 125px; border-radius: 5px; border: 1px solid #39c;"/>
    ...
    <center>
   <textarea  name="comentarios" rows="30" cols="200" placeholder="Escribe aquí el resumen">{{$resumens->resumen}}</textarea>
   </center>
 ...
 <center>
  <textarea  name="comentarios2" rows="20" cols="200" placeholder="Escribe aquí el resumen">{{$resumens->indicaciones}}</textarea>
  </center></span>
