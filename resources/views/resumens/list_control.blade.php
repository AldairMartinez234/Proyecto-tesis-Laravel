                ...
                <div class="modal-header">
                    ...
                    <div class="container-fluid" style="margin: 0px 0;">
                        <div class="page-header">
                            <h3 class="text-center all-tittles">SISTEMA DE CONTROL DE OXIGENO MEDICINAL
                                <small>Administración de pacientes</small></h3>
                        </div>
                    </div>
                            ...
                            <table id="example2" class="table table-bordered table-striped table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr class="item{{$control->id}}">
                                        ...
                                        <td> <a href="/control_entrega/{{$control->id}}" class="btn btn-primary"
                                                target="_blank"> <i class="glyphicon glyphicon-print"> </i></a>
                                            <a href="/control_oxigeno/{{$control->id}}" class="btn btn-primary"
                                        ...
                                        <td>
                                            <form action="" id="deleteForm5" method="post">
                                                ...
                                                <a type="button" id="{{$control->id}}" data-toggle="modal"
                                                    class='button delete-confirm5 btn btn-danger'>
