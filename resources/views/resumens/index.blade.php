        ...
        <div class="row">
            ...
            <form method="POST" action="{{route('resumens.update',$paciente->id)}}">
                ...
                <br><span style="float:right">
                    <pre> Folio No. <input type="number" name="folio" size="10" style="border-radius: 5px; border: 1px solid #39c;" /></pre>
                </span>
                <br><br><br>
                <span style="float:right">
                    <label>Fecha y hora: <input type="datatime" name="fecha" value="<?=  $fecha ?>"
