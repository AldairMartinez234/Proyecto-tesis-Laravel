...
<div class="container">
    ...
    <a data-toggle="modal" data-target="#Control"><button type="button" class="btn btn-success float-right"
            data-toggle="tooltip" data-placement="top"><i class="zmdi zmdi-account-add zmdi-hc-fw"></i>Control de
            Entrega</button></a>
            ...
            <table id="example4" class="table table-bordered table-striped table-hover" style="text-align: center;">
                ...
                <tbody>
                    ...
                    <tr class="item{{$vista->id}}">
                        ...
                        <td>{{$vista->nombre}}</td>
                        <td>{{$vista->fecha}}</td>
                        <td> <a href="{{route('resumens.imprimirs',$vista->id)}}" class="btn btn-primary"
                                target="_blank"> <i class="glyphicon glyphicon-print"> </i></a>
                            <a href="{{route('resumens.ver',$vista->id)}}" class="btn btn-primary" target="_blank">Ver
                        ...
                        <td>
                            <form action="" id="deleteForm4" method="post">
                                ...
                                <a type="button" id="{{$vista->id}}" data-toggle="modal"
                                    class='button delete-confirm4 btn btn-danger'>
