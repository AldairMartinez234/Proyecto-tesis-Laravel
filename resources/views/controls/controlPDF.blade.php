...
<body>
    ...
    <div class="">
      <div class="row">
         <div class="title-flat-form title-flat-blue"><center>CONTROL DE PACIENTE DE OXÍGENO O CPAC DOMICILIARIO</center></div><br><br>
<font size="2"><b>
...
FECHA DE BAJA: <input type="text" value="{{$paciente->baja}}" size="10"/> TELÉFONO: <input type="text" value="{{$paciente->telefono}}" size="10"/></b></font>
    <br><br>
    <table border="0.5" cellpadding="1" cellspacing="0"><tbody> <tr>
     
    <th><center>MES</center></th>

    <th><center>NOMBRE/FIRMA DEL PACIENTE O FAMILIAR RESPONSABLE</center></th>

    <th><center>SELLO DE LA JEFATURA DE CONSULTA EXTERNA</center></th>
