...
Route::middleware(['auth'])->group(function () {
	...
	Route::post('pacientes/store/{Token}', 'PacienteController@store')->name('pacientes.store')
	...
	Route::get('pacientes/ActivarLector/{Token}', 'PacienteController@lector')->name('pacientes.lector');

	Route::get('pacientes/VerificarLector/{Token}', 'PacienteController@lector_buscar')->name('pacientes.lector_buscar');

	Route::get('pacientes/PacienteRestApi/{token}/{desde}/{hasta}', 'PacienteController@PacienteRestApi')->name('pacientes.PacienteRestApi');

	Route::get('pacientes/httpush/{timestamp}/{token}', 'PacienteController@httpush')->name('pacientes.httpush');

	Route::get('pacientes/create/{Token}', 'PacienteController@create')->name('pacientes.create')
		->middleware('permission:pacientes.create');
	...
	Route::put('unidades/editar', 'Unidades_MedicasController@edit')->name('unidades.update')
		->middleware('permission:usuarios.edit');
	Route::put('buscarpaciente/huella', 'PacienteController@buscarhuella')->name('pacientes.huellas');
	...
	Route::POST('control/crear/{id}', 'ControlController@crear')->name('controls.crear');
